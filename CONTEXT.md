...
- Simplified the on-screen asset exposure tables by removing the `sector_name` column while keeping it available in CSV/XLSX downloads; guarded by updated expectations in `tests/testthat/test-mod_results_assets.R`.
